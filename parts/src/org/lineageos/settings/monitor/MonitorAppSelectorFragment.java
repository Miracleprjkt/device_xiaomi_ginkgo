...
public class MonitorAppSelectorFragment extends Fragment {

    public static final String PREF_AUTO_APPS = "monitor_auto_apps";

    private RecyclerView recyclerView;
    private MonitorAppsAdapter adapter;
    ...
    private void loadApps() {
        ...
        adapter = new MonitorAppsAdapter(packageManager, allApps, new MonitorAppsAdapter.OnAppClickListener() {
            @Override
