...
public class MonitorFpsMeter {
    ...
    public static synchronized MonitorFpsMeter getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new MonitorFpsMeter(context.getApplicationContext());
        }
        return sInstance;
    }

    private MonitorFpsMeter(Context context) {
        mContext = context;
    ...
    public void start() {
        String method = mPrefs.getString("monitor_fps_method", "new");
