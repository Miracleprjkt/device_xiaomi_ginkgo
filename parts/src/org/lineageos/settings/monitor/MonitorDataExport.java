...
public class MonitorDataExport {
    ...
    private static MonitorDataExport sInstance;
    public static synchronized MonitorDataExport getInstance() {
        if (sInstance == null) {
            sInstance = new MonitorDataExport();
        }
        return sInstance;
    }
    ...
    public void exportDataToCsv() {
        ...
        File outFile = new File(Environment.getExternalStorageDirectory(), "Monitor_log_" + timeStamp + ".csv");
