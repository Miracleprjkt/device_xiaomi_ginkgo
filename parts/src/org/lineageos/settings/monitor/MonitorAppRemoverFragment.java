...
public class MonitorAppRemoverFragment extends Fragment {

    private RecyclerView recyclerView;
    private MonitorAutoAppsAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.monitor_app_selector, container, false);
    }
    ...
    private void loadAutoApps() {
        ...
        adapter = new MonitorAutoAppsAdapter(packageManager, autoAppsList, new MonitorAutoAppsAdapter.OnAppRemoveListener() {
            @Override
    ...
    private Set<String> getSavedAutoApps() {
        return PreferenceManager.getDefaultSharedPreferences(getContext())
                .getStringSet(MonitorAppSelectorFragment.PREF_AUTO_APPS, new HashSet<>());
    }
    ...
    private void removeAppFromAutoList(String packageName) {
        ...
        PreferenceManager.getDefaultSharedPreferences(getContext())
                .edit().putStringSet(MonitorAppSelectorFragment.PREF_AUTO_APPS, autoApps).apply();
    }
}
