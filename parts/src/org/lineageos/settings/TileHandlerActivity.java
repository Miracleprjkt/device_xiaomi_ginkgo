...
import org.lineageos.settings.monitor.MonitorSettingsActivity;
import org.lineageos.settings.monitor.MonitorTileService;
...
public final class TileHandlerActivity extends Activity {
    ...
    static {
        TILE_ACTIVITY_MAP.put(MonitorTileService.class.getName(), MonitorSettingsActivity.class);
    }
